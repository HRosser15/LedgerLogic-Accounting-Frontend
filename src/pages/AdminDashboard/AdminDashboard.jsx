...
const AdminDashboard = () => {
  ...
  const [showExpiredPasswordsModal, setShowExpiredPasswordsModal] = useState(false);
  ...
  return (
    <Container className={styles.dashboardContainer}>
      ...
      <Row className="mt-4">
        <Col>
          <Button variant="info" onClick={() => handleButtonClick("ViewAllUsers")}>
            View All Users
          </Button>
        </Col>
        ...
        <Col>
          ...
          <Modal show={showExpiredPasswordsModal} onHide={handleCloseExpiredPasswordsModal}>
            ...
            <Modal.Footer>
              <Button variant="secondary" onClick={handleCloseExpiredPasswordsModal}>
                Close
              </Button>
        ...
        <Col>
          <Button variant="info" onClick={() => handleButtonClick("CreateNewUser")}>
            Create New User
          </Button>
        </Col>
      </Row>
      ...
      <Row className="mt-4">
        ...
        <Col>
          <Button variant="success" onClick={() => { handleButtonClick("ActivateUser"); handleShowModal(); }}>
            Activate User
          </Button>
        </Col>

        <Col>
          <Button variant="warning" onClick={() => { handleButtonClick("DeactivateUser"); handleShowModal(); }}>
            Deactivate User
          </Button>
        </Col>
      ...
      <Row>
        <Col>
          <Button variant="primary" onClick={() => handleButtonClick("SendEmailToUser")}>
            Send Email to User
          </Button>
        </Col>
      </Row>
