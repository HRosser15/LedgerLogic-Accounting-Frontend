...
import { deactivateAccount, fetchAccounts } from "../../../services/AccountService";
...
const DeactivateAccountsForm = () => { 
    ...
    const handleDeactivateAccount = async (accountId) => {
        try {
          ...
          const updatedAccounts = accounts.filter((acc) => acc.accountNumber !== accountId);
          ...
          <tbody>
            {filteredTableAccounts.map((account) => (
              <tr key={account.accountNumber}>
                ...
                <td>
                    <button className="button" onClick={handleDeactivateAccount(account.accountNumber)}>Delete Account</button>
                </td>
              </tr>
            ))}
          </tbody>
