...
import AccountantViewLedger from "./Forms/ViewLedger";
import AccountantCreateJournal from "./Forms/CreateJournalEntry";
  ...
  return (
    <Container className={styles.dashboardContainer}>
      ...
      <Tabs
        ...
        onSelect={(key) => {
          if (key === "/accountant-accounts-management/ledgers") {
            setSelectedAccount(null);
          }
          navigate(key);
        }}
      ...
      >
        <Tab
          eventKey="/accountant-accounts-management"
          title={<span title="View existing accounts">Chart of Accounts</span>}
        >
          <div style={{ height: "20px" }}></div>
        </Tab>
        <Tab
          eventKey="/accountant-accounts-management/ledgers"
          title={<span title="View account ledgers">Ledgers</span>}
        >
          <div style={{ height: "20px" }}></div>
        </Tab>
        <Tab
          eventKey="/accountant-accounts-management/journal"
          title={<span title="Open journal">Journal</span>}
        ></Tab>
        <Tab
          eventKey="/accountant-accounts-management/event-log"
