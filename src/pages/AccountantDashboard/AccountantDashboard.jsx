            ...
            <Card.Body>
              ...
              <Card.Text>
                <Row>
                  ...
                  <Col xs={6}>
                    <span className={`${styles.circle} ${currentRatioHealth}`}>
                      {currentRatio}
                    </span>
                  </Col>
                </Row>
                ...
                <Row>
                  ...
                  <Col xs={6}>
                    <span className={`${styles.circle} ${quickRatioHealth}`}>
                      {quickRatio}
                    </span>
                  </Col>
                </Row>
            ...
            <Card.Body>
              ...
              <Card.Text>
                <Row>
                  ...
                  <Col xs={6}>
                    <span
                      className={`${styles.circle} ${grossProfitMarginHeath}`}
                    >
                      {grossProfitMargin}
                    </span>
                  </Col>
                ...
                <Row>
                  ...
                  <Col xs={6}>
                    <span
                      className={`${styles.circle} ${netProfitMarginHealth}`}
                    >
                      {netProfitMargin}
                    </span>
                  </Col>
                ...
                <Row>
                  ...
                  <Col xs={6}>
                    <span className={`${styles.circle} ${ROAHealth}`}>
                      {ROA}
                    </span>
                  </Col>
                </Row>
                ...
                <Row>
                  ...
                  <Col xs={6}>
                    <span className={`${styles.circle} ${ROEHealth}`}>
                      {ROE}
                    </span>
                  </Col>
                </Row>
